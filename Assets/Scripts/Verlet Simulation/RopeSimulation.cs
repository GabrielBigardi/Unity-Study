...
namespace Demo
{
    public class RopeSimulation : MonoBehaviour
    {
        ...
        [SerializeField] private VerletLauncher playerVerletLauncher;
        ...
        private void FixedUpdate()
        {
            ...
            //Vector3 mousePosition = InputHandler.Instance.MousePositionWorld;
            //mousePosition.z = 0f;
            //Dot firstDot = simulator.Dots[0];
            //firstDot.CurrentPosition = mousePosition;
            simulator.Simulate(Time.fixedDeltaTime);
            Dot lastDot = simulator.Dots[simulator.Dots.Count - 1];
